...
from qwen3 import Qwen3Model, Qwen3Tokenizer, QWEN_4B_CFG, from_pretrained
...
class Qwen3_Lightning(pl.LightningModule):
    ...
    def configure_model(self):        
        ...
        self.model = apply_lora(
            ...
            rank=CFG.RANK, 
            alpha=CFG.ALPHA, 
            target_modules=["W_query", "W_key", "W_value",\
                    "out_proj", "fc1", "fc2", "fc3"]
        )
...
if __name__ == '__main__':
    ...
    model = from_pretrained(model, repo_id="Qwen/Qwen3-4B")
    ...
    logger = pl.loggers.CSVLogger(
        save_dir=f'./logs/9_Qwen3_4B_Jigsaw_LoRA_r{CFG.RANK}_a{CFG.ALPHA}/', 
        name=f'{date}'
    )
